...
function returnButton(hideElement, showElement) {
    document.getElementById(hideElement).style.display = "none";
    document.getElementById(showElement).style.display = "block";
    var sendAjax = false;
    var urlPetition = "";
    switch (showElement) {
        case 'characteristics':
            sendAjax = true;
            urlPetition = "characteristics/get-by-gender/" + towhoVal
            showCharacteristics(urlPetition);
            break;
        case 'price_range':
            sendAjax = true;
            urlPetition = "price_characteristics/get-by-character/" + characteristicVal
            showPricesByCharacteristic(urlPetition);
            break;
        case 'choose_gitf':
            sendAjax = true;
            urlPetition = "set_product/get-by-set/" + rangePriceVal
            showProductosByRange(urlPetition);
            break;
        default:
            break;
